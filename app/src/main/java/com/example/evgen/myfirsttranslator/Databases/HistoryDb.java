...
/**
 * Created by Evgen on 24.04.2017.
 */
...
public class HistoryDb {
    ...
    public void addRec(String sourseText, String transText, String codeFrom, String codeTo){
        ContentValues cv = new ContentValues();
        cv.put(HistoryDb.KEY_SOURSE_TEXT, sourseText);
        cv.put(HistoryDb.KEY_TRANS_TEXT, transText);
        cv.put(HistoryDb.KEY_SOURSE_LANG, codeFrom);
        cv.put(HistoryDb.KEY_TRANS_LANG, codeTo);
        mDb.insert(HistoryDb.TABLE_NAME, null, cv);
    }
